...
Build and grow your community with BootForum2. This forum application is lightweight and can be run in an EC2 instance with 2GB of memory (with embedded H2 database). But this application can also be run in any JDBC-compliant database (Oracle, Postgresql, MySQL, SQL Server, etc).
...
###  [**Live Demo**](http://ec2-54-172-83-73.compute-1.amazonaws.com/ "BootForum2 Demo")
