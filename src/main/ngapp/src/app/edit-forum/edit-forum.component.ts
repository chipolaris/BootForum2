...
@Component({
  ...
  styleUrls: ['./edit-forum.component.css'] // You can reuse create-forum.component.css or create a new one
})
export class EditForumComponent implements OnInit {
  ...
  onCancel(): void {
    ...
    this.router.navigate(['/app/dashboard']); // Or use Location.back()
  }
}
