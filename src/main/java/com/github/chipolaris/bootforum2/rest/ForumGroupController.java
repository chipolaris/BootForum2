...
public class ForumGroupController {
    ...
    public ApiResponse<?> createForumGroup(@Valid @RequestBody ForumGroupDTO forumGroupDTO) {
        try {
    ...
    public ApiResponse<?> updateForumGroup(@PathVariable Long id, @Valid @RequestBody ForumGroupDTO forumGroupDTO) {
