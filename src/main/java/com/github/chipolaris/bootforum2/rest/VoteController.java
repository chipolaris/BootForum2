...
@RestController
@RequestMapping("/api/user") // Base path for user-specific actions
public class VoteController {
    ...
    public ApiResponse<?> voteOnComment(
        ...
        try {
            ...
            logger.error(String.format("Unexpected error while processing vote for comment ID %d", commentId), e);
